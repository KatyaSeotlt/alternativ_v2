...
function victoryExchangeFunc() {
    ...
    switch (data) {
      case 'password_reset':
        if (type == 'getpath') {
          ...
          _this.passwordReset(responseData);
        }
        break;
      case 'password_code':
        if (type == 'getpath') {
          ...
          _this.passwordCode(responseData);
        }
        break;
      case 'password_token':
        if (type == 'getpath') {
          ...
          _this.passwordToken(responseData);
        }
        break;
      case 'logout':
        if (type == 'getpath') {
      ...
      case 'list':
        if (type == 'getpath') {
          ...
          search = 1;
          isSearch = 0;
          _this.routesshow(responseData, '#listblocks');
        }
        break;
      case 'map_points':
        if (type == 'getpath') {
      ...
      case 'person':
        if (type == 'getpath') {
          ...
          _this.setUserProfile(responseData);
        }
        break;
      case 'orders':
        if (type == 'getpath') {
          ...
          search = 1;
          _this.routesshow(responseData, '#routesblocks');
        }
        break;
      case 'map_detail':
        if (type == 'getpath') {
          return {
            path: 'map/points/info',
            method: 'POST'
          };
        } else {
          _this.mapRoutesDetail(responseData);
        }
        break;
      case 'firstperson':
        if (type == 'getpath') {
      ...
      case 'activationuserlogin':
        if (type == 'getpath') {
          ...
          _this.activationuserlogin(responseData);
        }
        break;
      case 'cities_search':
        if (type == 'getpath') {
          return {
            path: 'cities/' + responseData,
            method: 'GET'
          };
        } else {
          cityIsSearched = 0;
          _this.createDivCity(responseData);
        }
        break;
      case 'person_edit':
        if (type == 'getpath') {
      ...
      case 'car_types':
        if (type == 'getpath') {
          return {
            path: 'settings/cars/types',
            method: 'GET'
          };
        } else {
          car_types = responseData;
          vicFunc.carsshow();
        }
        break;
      case 'cargo_types':
        if (type == 'getpath') {
          return {
            path: 'settings/cargo/types',
            method: 'GET'
          };
        } else {
          cargo_types = responseData;
        }
        break;
      case 'payment_types':
        if (type == 'getpath') {
          ...
          payment_types = responseData;
        }
        break;
      case 'loading_types':
        if (type == 'getpath') {
          return {
            path: 'settings/loading/types',
            method: 'GET'
          };
        } else {
          loading_types = responseData;
        }
        break;
      case 'car_create':
        if (type == 'getpath') {
          return {
            path: 'settings/cars/create',
            method: 'POST'
          };
        } else {
          _this.savecardata(responseData);
          vicFunc.carsshow();
        }
        break;
      case 'tickets':
        if (type == 'getpath') {
          ...
          _this.ticketThemeCreate(responseData);
        }
        break;
      case 'create_subscriptions':
        if (type == 'getpath') {
          ...
          _this.addSubscriptions(responseData);
        }
        break;
      case 'callback':
        if (type == 'getpath' && !_this.isUndefined(responseData)) {
          return {
            path: responseData + '/callback',
            method: 'POST'
          };
        } else {}
        break;
      case 'orders_nextstate':
        if (type == 'getpath' && !_this.isUndefined(responseData)) {
          return {
            path: 'orders/' + responseData + '/nextstate',
            method: 'POST'
          };
        } else {}
        break;
      case 'ticket_view':
        if (type == 'getpath' && !_this.isUndefined(responseData)) {
          return {
            path: 'tickets-list/' + responseData + '/view',
            method: 'GET'
          };
        } else {
          _this.ticketThemeView(responseData);
        }
        break;
      case 'ticket_message':
        if (type == 'getpath' && !_this.isUndefined(responseData)) {
          return {
            path: 'tickets-list/' + responseData + '/message',
            method: 'POST'
          };
        } else {
          _this.ticket_message(responseData);
        }
        break;
      case 'ticket_close':
        if (type == 'getpath' && !_this.isUndefined(responseData)) {
          return {
            path: 'tickets-list/' + responseData + '/close',
            method: 'POST'
          };
        } else {}
        break;
      case 'ticket_order':
        if (type == 'getpath' && !_this.isUndefined(responseData)) {
          return {
            path: responseData + '/ticket',
            method: 'POST'
          };
        } else {
          myApp.closeModal('.popup-addticket');
          _this.openInfoPopupTicket(lang.tiket_created, responseData.id);
        }
        break;
      case 'delete_subscriptions':
        if (type == 'getpath' && !_this.isUndefined(responseData)) {
          return {
            path: 'settings/subscriptions/' + responseData + '/delete',
            method: 'DELETE'
          };
        } else {}
        break;
      case 'enable_subscriptions':
        if (type == 'getpath' && !_this.isUndefined(responseData)) {
          return {
            path: 'settings/subscriptions/' + responseData + '/enable',
            method: 'POST'
          };
        } else {}
        break;
      case 'car_delete':
        if (type == 'getpath' && !_this.isUndefined(responseData)) {
          return {
            path: 'settings/cars/' + responseData + '/delete',
            method: 'DELETE'
          };
        } else {}
        break;
      case 'enable_cars':
        if (type == 'getpath' && !_this.isUndefined(responseData)) {
          return {
            path: 'settings/cars/' + responseData + '/enable',
            method: 'POST'
          };
        } else {}
        break;
      case 'car_edit':
        if (type == 'getpath' && !_this.isUndefined(responseData)) {
          return {
            path: 'settings/cars/' + responseData + '/edit',
            method: 'POST'
          };
        } else {}
        break;
      case 'get_car_edit':
        if (type == 'getpath' && !_this.isUndefined(responseData)) {
          ...
          _this.changeCar(responseData);
        }
        break;
      case 'get_dispetcher_phone_by_order_id':
        if (type == 'getpath' && !_this.isUndefined(responseData)) {
          return {
            path: 'orders/' + responseData + '/contacts',
            method: 'POST'
          };
        } else {
          _this.changeContactDispetcher(responseData);
        } ///orders/{order}/contacts
        break;
      case 'addtosubscriptions':
        if (type == 'getpath' && !_this.isUndefined(responseData)) {
          return {
            path: responseData + '/addtosubscriptions',
            method: 'POST',
            accept: 'text/html'
          };
        } else {
          _this.openInfoPopup(lang.route_set_in_subscribe);
        }
        break;
      case 'rateoffer':
        if (type == 'getpath' && !_this.isUndefined(responseData)) {
          return {
            path: responseData + '/rateoffer',
            method: 'POST'
          };
        } else {
          _this.openInfoPopup(lang.rate_seng_dispether);
        }
        break;
      case 'routerequest':
        if (type == 'getpath' && !_this.isUndefined(responseData)) {
          return {
            path: responseData + '/routerequest',
            method: 'POST'
          };
        } else {
          _this.openInfoPopup(lang.rate_seng_dispether);
  ...
  this.login = function(login, password) {
    ...
    if (_this.isOnline()) {
      var data = {
        phone: login,
        password: password,
        push: window.localStorage.getItem("registrationId")
      };
  ...
  this.dummypush = function() {
    var data = {
      apikey: window.localStorage.getItem("registrationId"),
  ...
  this.getdataserver = function(parent, data, variable) {
    if (_this.isOnline()) {
      ...
      if (requestnow == 1) {
        ...
        setTimeout(function() {
          _this.getdataserver(parent, data, variable);
        }, 2000);
      } else {
        requestnow = 1;
  ...
  if(responseData.state_id!=3){
    ...
    for (var theme in messages) {
      if (messages.hasOwnProperty(theme)) {
        var className = '';
        if (messages[theme].operator_id !== null) {
          className = 'operator';
        }
        if (messages[theme].user_id !== null) {
          className = 'user';
        }
  ...
  this.ticketThemeCreate = function(responseData) {
    var html = '';
    var className = new Array('', 'new', 'answered', 'closeico');
    ...
    $$('.theme-block').on('click', function() {
      ...
      if (theme_id !== undefined) {
		...
		$$('.messages-tab').on('click', function() {
			_this.openInfoPopup(lang.chooseTheme);
			});
  };
        ...
        if (ismapcreate !== null) {
          ...
          if (subscriptionsfrom !== '') {
            ...
            routeApp.then(
              ...
              function(error) {
                _this.openInfoPopup(lang.routes_error);
                showlog(error);
              }
            );
          }
              ...
              myObjects.push({
                ...
                geometry: {
                  ...
                  coordinates: [responseData[i].Latitude, responseData[i].Longitude]
					...
					if(myObjectManager !== undefined){
          myObjectManager.objects.options.set('geoObjectOpenBalloonOnClick', false);
          ...
          myObjectManager.clusters.events.add('click', function(e) {
            ...
            vicFunc.getdataserver('map_detail', {
              orders_ids: objArr
            });
          });
          myObjectManager.objects.events.add('click', function(e) {
            vicFunc.getdataserver('map_detail', {
              orders_ids: [e.get('objectId')]
            });
          });
    ...
    if (_this.isUndefined(userProfileData.cars)) {
      ...
      for (var car in carList) {
        if (carList.hasOwnProperty(car)) {
          ...
          if (carList[car].enabled == 1) {
            carHtml = carHtml + 'checked="checked"';
          }
      ...
      $$('.enabled_cars').on('change', function() {
        ...
        if ($$(this).prop('checked') === true) {
          ...
          vicFunc.getdataserver('enable_cars', {
            enabled: true
          }, enabled_id);
        } else {
  ...
  this.showSubscribe = function() {
    ...
    for (var i in userProfileData.subscriptions) {
      ...
      if (userProfileData.subscriptions.hasOwnProperty(i)) {
        ...
        var check = '';
        if (userProfileData.subscriptions[i].enabled == 1) {
          html = html + lang.enabled;
          check = 'checked="checked"';
        } else {
          html = html + lang.disabled;
        }
        html = html + '</div>' +
    ...
    $$('.enabled_subscribe').on('change', function() {
      ...
      if ($$(this).prop('checked') === true) {
        ...
        vicFunc.getdataserver('enable_subscriptions', {
          enabled: true
        }, enabled_id);
      } else {
  ...
  this.saveSubscribe = function() {
    _this.subscribeCganged = true;
    var data = {
      city_from_id: $$('#begin_id').val(),
      city_to_id: $$('#end_id').val()
    };
  ...
  this.openfirst = function(responseData) {
    ...
    $$('#exit_icon').on('click', function() {
      vicFunc.getdataserver('logout', {
        push: localStorage.getItem('registrationId')
      });
      window.localStorage.clear();
      myApp.closePanel();
      mainView.router.loadPage("index.html");
  ...
  this.activationuserlogin = function(responseData) {
    if (responseData.message == "auth.timeout") {
      ...
      setTimeout(function() {
        data = {
          resend_token: window.localStorage.getItem("resend_token")
        };
        vicFunc.getdataserver('activationuserlogin', data);
      }, timeout);
    }
...
myApp.onPageInit('map-routes', function() {
  ...
  for (var i in map_Routes_Detail) {
    if (map_Routes_Detail.hasOwnProperty(i)) {
      ...
      var cargo_length = '';
      if (map_Routes_Detail[i].cargo_length > 0) {
        cargo_length = map_Routes_Detail[i].cargo_length + ' м&nbsp;<i>x</i>&nbsp;';
      }
      var cargo_width = '';
      if (map_Routes_Detail[i].cargo_width > 0) {
        cargo_width = map_Routes_Detail[i].cargo_width + ' м&nbsp;<i>x</i>&nbsp;';
      }
      var cargo_height = '';
      if (map_Routes_Detail[i].cargo_height > 0) {
        cargo_height = map_Routes_Detail[i].cargo_height + ' м';
      }
...
function newpasswordstep3() {
  ...
  var data = {
    reset_pass_code: $$('#new_password_sms_code').val()
  };
...
function newpasswordstep4() {
  ...
  var data = {
    reset_pass_token: window.localStorage.getItem("resend_token"),
...
$$('#search_save').on('click', function() {
  ...
  if ($$('#only_subscribe').prop('checked') === true) {
    only_my_subscriptions = 1;
